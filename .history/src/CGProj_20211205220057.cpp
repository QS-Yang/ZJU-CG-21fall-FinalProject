...
int main()
{
    ...
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/grass.png"));
    TerrainTexture gTexture = TerrainTexture(loader.loadTexture("../texture/grass.png"));
