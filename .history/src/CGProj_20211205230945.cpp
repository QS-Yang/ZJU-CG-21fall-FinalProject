...
int main()
{
    ...
    TerrainTexture backgroundTexture = TerrainTexture(loader.loadTexture("../texture/grass.png", 256, 256, 3));
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/grassTexture.png", 256, 256, 3));
    TerrainTexture gTexture = TerrainTexture(loader.loadTexture("../texture/grass.png", 256, 256, 3));
    TerrainTexture bTexture = TerrainTexture(loader.loadTexture("../texture/path.png", 256, 256, 3));

    TerrainTexturePack texturePack(backgroundTexture, rTexture, gTexture, bTexture);
    TerrainTexture blendMap = TerrainTexture(loader.loadTexture("../texture/blendMap.png", 256, 256, 3));
    //
