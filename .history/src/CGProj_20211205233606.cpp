...
int main()
{
    ...
    TerrainTexture backgroundTexture = TerrainTexture(loader.loadTexture("../texture/mud.png"));
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/white.png"));
    ...
    Terrain terrain1(1, 1, loader, texturePack, blendMap);
