...
int main()
{
    ...
    TerrainTexture backgroundTexture = TerrainTexture(loader.loadTexture("../texture/blendMap.png", 1024, 1024, 3));
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/grass.png", 256, 256, 3));
    TerrainTexture gTexture = TerrainTexture(loader.loadTexture("../texture/grass.png", 256, 256, 3));
    TerrainTexture bTexture = TerrainTexture(loader.loadTexture("../texture/white.png", 256, 256, 3));

    TerrainTexturePack texturePack(backgroundTexture, rTexture, gTexture, bTexture);
    TerrainTexture blendMap = TerrainTexture(loader.loadTexture("../texture/blendMap.png", 1024, 1024, 2));
    //
    vector<string> filenames{"../object/Car2.obj"};
    Texture rawtexture=Texture(loader.loadTexture("../texture/blendMap.png", 1024, 1024, 3));
