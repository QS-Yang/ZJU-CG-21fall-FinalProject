...
int main()
{
    ...
    TerrainTexture backgroundTexture = TerrainTexture(loader.loadTexture("../texture/grassy.png"));
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/dirty.png"));
    TerrainTexture gTexture = TerrainTexture(loader.loadTexture("../texture/pinkFlowers.png"));
