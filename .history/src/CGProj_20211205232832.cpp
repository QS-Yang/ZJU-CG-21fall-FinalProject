...
int main()
{
    ...
    TerrainTexture backgroundTexture = TerrainTexture(loader.loadTexture("../texture/blendMap.png", 256, 256, 4));
    TerrainTexture rTexture = TerrainTexture(loader.loadTexture("../texture/white.png", 256, 256, 3));
    TerrainTexture gTexture = TerrainTexture(loader.loadTexture("../texture/mud.png", 256, 256, 4));
    TerrainTexture bTexture = TerrainTexture(loader.loadTexture("../texture/path.png", 256, 256, 4));
